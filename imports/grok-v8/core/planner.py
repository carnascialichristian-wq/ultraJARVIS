...
def plan(task_text: str) -> Plan:
    ...
    This is a deterministic, lightweight planner that extracts a title
    and generates sensible default milestones / criteria. In production
    it can be replaced or augmented by an LLM call.

    Also surfaces existing registry tools that may already cover the need.
    """
