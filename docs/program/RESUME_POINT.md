...
> Read the full canonical prompt, `AGENTS.md`, and every artifact indexed by
> `docs/program/README.md` at `ULTRAJARVIS_HEAD`. Reconcile the branch with
> `docs/program/BACKLOG.json`. Run `node scripts/validate-program-os.mjs` and
